...
# 1-й Вопрос - из поля quest1
    @question = Question.find(@seance.quest1)    
...
byebug
    if @howmuch == 1
      ...
      @question = Question.find(@seance.quest2)
    elsif @howmuch == 2
      @seance.be_quests = @seance.be_quests + '2, '
      if @one == 1
        @seance.answ2 = 1
      elsif @two == 1
        @seance.answ2 = 2
      ...
      @question = Question.find(@seance.quest3)
    elsif @howmuch == 3
      @seance.be_quests = @seance.be_quests + '3, '
      if @one == 1
        @seance.answ3 = 1
      elsif @two == 1
        @seance.answ3 = 2
      ...
      @question = Question.find(@seance.quest4)
    elsif @howmuch == 4
      @seance.be_quests = @seance.be_quests + '4, '
      if @one == 1
        @seance.answ4 = 1
      elsif @two == 1
        @seance.answ4 = 2
      ...
      @question = Question.find(@seance.quest5)
    elsif @howmuch == 5
      @seance.be_quests = @seance.be_quests + '5; '
      if @one == 1
        @seance.answ5 = 1
      elsif @two == 1
        @seance.answ5 = 2
